...
export const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        gun.get("eUfOJl1mmiz6n0fColrU0cTY").put({ null: null })         // this is for first user entering our website  // this is to make the node with {null: null} (if it is not already made) because in some components we are directly looping the data of the node(which might not be created yet)
    ...
    const handleFriendSearchButton = () => {
        ...
        if (friendSearch === currentUser) {
            ...
            // gun.get("eUfOJl1mmiz6n0fColrU0cTY").once(data => console.log(data))
        }
    }
